...
// 基本タワー（最初から解放）
export const BASIC_TOWER_KINDS = ['archer', 'mage', 'cannon', 'ice', 'fire'];
// 上級タワー（段階解放）
export const ADVANCED_TOWER_KINDS = ['thunder', 'sniper', 'support', 'ballista'];
export const TOWER_KINDS = [...BASIC_TOWER_KINDS, ...ADVANCED_TOWER_KINDS];
...
export function scaledCost(baseCost, sameTypeCount) {
