...
export class TowerDetailPanel {
    constructor(scene, state, onSell) {
        ...
        Object.defineProperty(this, "btnGraphics", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "upgradeLabel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "sellLabel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "onSell", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "pw", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "upgBtnY", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "sellBtnY", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnH", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 28
    ...
    render() {
        ...
        this.text.setText(`${def.name} [${levelNames[tower.level]}]\n` +
            synergyLine +
            `${dmgLabel}: ${fmtDmg}\n` +
            `攻撃速度: ${fmtSpd}\n` +
            `射程: ${fmtRange}\n` +
    ...
    onUpgradeClick() {
        ...
        if (!tower || !tower.canUpgrade())
            return;
        if (!this.state.spendGold(tower.upgradeCost))
            return;
        tower.upgrade();
        this.render();
    }
